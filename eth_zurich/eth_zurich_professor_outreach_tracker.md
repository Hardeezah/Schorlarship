...
**Target Program:** Direct Doctorate in Computer Science (Fast-track B.Sc. to PhD)  
**Funding Package:** 100% Tuition Waiver + CHF 24k–27k/year (Master's) + **CHF 55k–70k+/year Salary** (PhD)  
**Portal Application Window:** November 1 – November 30, 2026  
...
| :--- | :--- |
| ✅ **AGREED** | Supervisor agreed to support Direct Doctorate nomination |
...
#### 1. Prof. Torsten Hoefler
* **Department:** Department of Computer Science (D-INFK)
* **Lab:** Scalable Parallel Computing Laboratory (SPCL)
* **Research Focus:** High-Performance Computing, Data-Centric (DaCe) Parallel Programming, Deep Learning Compilation, Memory-Hierarchy Co-Design
* **Email:** `spcl-hiring@spcl.inf.ethz.ch` (SPCL Automated Filter Tag: `[JOB@SPCL]`)
...
4. **Admissions Interviews:** January – February 2027
5. **Final Results Announced:** March 2027
